...
const formRules: FormRules = {
  ...
  signInStartTime: [
    { required: true, message: '请选择签到开始时间', trigger: 'change' },
  ],
  signInEndTime: [
...
async function loadEditData(): Promise<void> {
  ...
  try {
    ...
    if (detail.coverUrl) {
      ...
      coverFileList.value = [
        { name: 'cover.jpg', url: detail.coverUrl } as UploadFile,
      ]
    }
    ...
    <div class="page-container">
      ...
      <div class="content-card">
        ...
        >
            ...
            <el-row :gutter="24">
              ...
              <el-col :xs="24" :sm="12">
                <el-form-item label="所属支部" prop="branch">
                  ...
                  <!-- 支委权限提示 -->
                  <span v-if="isSecretary" class="form-hint">
                    支委仅可创建本支部活动
                  </span>
                </el-form-item>
              </el-col>
          ...
          <div class="form-section">
            ...
            <!-- 指定身份多选框（选择"指定身份"时显示） -->
            <el-form-item
              v-if="formData.participantScope === 'specified'"
              label="指定身份"
            >
      ...
      <div class="form-footer">
        <div class="footer-inner">
          <el-button size="large" @click="handleCancel" :disabled="submitting">
            取消
          </el-button>
