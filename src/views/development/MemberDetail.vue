...
<template>
  <div class="member-detail-page">
        ...
        <el-card class="member-card" shadow="hover">
          ...
          <div class="avatar-section">
            <div class="avatar-placeholder">
              <img src="@/assets/images/Party/党徽黄色1024X1024.png" alt="党徽" class="party-emblem" />
            </div>
          </div>
      ...
      <section class="right-panel">
        ...
        <div class="top-bar">
          ...
          <div class="top-bar-right">
            ...
            -->
            <el-button v-if="canAdjustIdentity" type="primary" @click="handleAdjustIdentity"> 调整身份 </el-button>
            <el-button v-if="canAdjustIdentity" type="warning" @click="handleBatchAdjust"> 批量调整 </el-button>
          </div>
        </div>
          ...
          <el-tabs v-model="activeTab" class="detail-tabs">
            ...
            <el-tab-pane label="培养记录" name="training">
              <div class="tab-header">
                ...
                <el-button type="primary" size="small" @click="handleUploadMaterial"> 上传材料 </el-button>
              </div>
              ...
              <el-empty v-if="trainingRecords.length === 0" description="暂无培养记录" />
            </el-tab-pane>
            ...
            <el-tab-pane label="思想汇报" name="report">
              ...
              <el-empty v-if="thoughtReports.length === 0" description="暂无思想汇报" />
            </el-tab-pane>
            ...
            <el-tab-pane label="活动参与" name="activity">
              ...
              <el-table :data="activities" style="width: 100%" stripe>
                ...
                <el-table-column label="签到状态" width="120">
                  <template #default="{ row }">
                    <el-tag :type="row.checkInStatus === '已签到' ? 'success' : 'info'" size="small">
                      {{ row.checkInStatus }}
                    </el-tag>
                  </template>
                </el-table-column>
    ...
    <!-- ==================== 上传材料弹窗（占位） ==================== -->
    <el-dialog v-model="uploadDialogVisible" title="上传培养材料" width="500px" :close-on-click-modal="false">
