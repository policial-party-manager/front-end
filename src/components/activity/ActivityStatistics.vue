...
import { UserFilled, CircleCheckFilled, CircleCloseFilled, TrendCharts } from "@element-plus/icons-vue";
  ...
  <div class="activity-statistics" v-loading="loading" element-loading-text="加载统计数据...">
    ...
    <div class="chart-section">
      ...
      <div class="chart-wrapper">
        ...
        <el-empty v-if="!chartInited && !loading" description="暂无签到数据" :image-size="80" class="chart-empty" />
      </div>
    </div>
  </div>
</template>
...
/* 卡片色调微调 — 数字用主题色 */
.stat-card--signed .stat-card__num {
  color: #529b2e;
}
.stat-card--unsigned .stat-card__num {
  color: #b88230;
}
.stat-card--rate .stat-card__num {
  color: $party-red;
}
