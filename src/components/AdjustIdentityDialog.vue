...
const formRules = {
  targetIdentity: [
    { required: true, message: '请选择目标身份', trigger: 'change' },
  ],
  reason: [
  ...
  >
    ...
    <div class="member-summary">
      ...
      <div class="summary-item">
        ...
        <el-tag
          :type="identityTagMap[memberInfo.currentIdentity] || 'info'"
          size="small"
        >
    ...
    >
      ...
      <el-form-item label="目标身份" prop="targetIdentity">
        <el-select
          v-model="formData.targetIdentity"
          placeholder="请选择目标身份"
          style="width: 100%"
        >
          <el-option
          ...
          >
            ...
            <el-tag
              v-if="item.value === memberInfo.currentIdentity"
              size="small"
              type="info"
